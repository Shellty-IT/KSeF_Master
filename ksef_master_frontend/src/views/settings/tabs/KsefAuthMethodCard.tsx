        ...
        <div className="ks-card p-5 space-y-5">
            ...
            <div className="flex gap-2">
                {[
                    ...
                    <label key={value}
                        className={`flex cursor-pointer items-center gap-2 rounded-lg border-2 px-3 py-2 text-sm font-medium transition ${disabled ? 'cursor-not-allowed opacity-50' : ''} ${authMethod === value ? 'border-accent bg-accent/10 text-accent' : 'border-[oklch(0.78_0.01_250)] bg-[oklch(0.97_0.005_250)] text-foreground hover:border-accent/50 hover:bg-accent/5'}`}>
