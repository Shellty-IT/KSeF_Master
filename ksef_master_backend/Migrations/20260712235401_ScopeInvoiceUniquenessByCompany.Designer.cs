...
namespace KSeF_Backend.Migrations
{
    ...
    [Migration("20260712235401_ScopeInvoiceUniquenessByCompany")]
    partial class ScopeInvoiceUniquenessByCompany
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KSeF.Backend.Models.ExternalDraft", b =>
                {
                    ...
                    b.Property<string>("SmartQuoteId")
                        .IsRequired()
                        .HasMaxLength(128)
                    ...
                    b.HasIndex("SellerNip");

                    b.HasIndex("SmartQuoteId")
                        .IsUnique();

                    b.HasIndex("Status");

                    b.ToTable("ExternalDrafts");
                });
